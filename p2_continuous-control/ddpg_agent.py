...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done, timestep):
        ...
        #In other words explore mainly and learn from experience replay at every 20 steps
    ...
    def learn(self, experiences, gamma):
        ...
        actions_next = self.actor_target(next_states) # Calling forward function of actor
        Q_targets_next = self.critic_target(next_states, actions_next) # Calling forward function of critic
